...
- Interactive live dashboard: https://risk-adaptive-flight-routing.streamlit.app/
- In a later development phase, this risk-adaptive routing engine will be  integrated into the autonomous drone ecosystem for real-time wolf detection, deterrence, and active livestock protection. The repository for this project can be found here:: <https://github.com/jostoelz/Autonomous-Drone-System-for-Wolf-Detection-Deterrence-and-Sheep-Protection>
...
---
✨ Enjoy exploring the project moring the thesis materials. 
